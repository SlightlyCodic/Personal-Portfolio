...
export function ContactSection() {
  ...
  return (
    <SparklesSection
      id="contact"
      className="scroll-section py-[120px] px-6 flex flex-col items-center gap-12 bg-[var(--bg-color)] relative transition-colors duration-300
        ...
        max-sm:py-[60px] max-sm:px-5 max-sm:gap-8
        max-[480px]:py-20 max-[480px]:px-4 max-[480px]:gap-7
