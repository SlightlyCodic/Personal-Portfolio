...
export function CliSection() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('npx chirag');
    setCopied(true);
    setTimeout(() => setCopied(false), 1500);
  };

  return (
    <section className="py-6 px-12 flex justify-center items-center max-sm:py-6 max-sm:px-5 max-[480px]:py-5 max-[480px]:px-4 max-[360px]:px-3">
