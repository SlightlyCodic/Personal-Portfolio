...
export function SocialLink({ href, icon, label, tooltip, showLabel = true }: SocialLinkProps) {
  return (
    <a
      ...
      className="inline-flex items-center gap-2.5 px-4 py-2 bg-transparent text-[var(--text-color)] border border-[var(--border-color)] opacity-80 rounded transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] hover:opacity-100 hover:bg-[var(--hover-bg-color)] hover:-translate-y-px focus:opacity-100 focus:bg-[var(--hover-bg-color)] focus:outline-none focus-visible:outline-2 focus-visible:outline-[rgba(255,255,255,0.6)] focus-visible:outline-offset-2
